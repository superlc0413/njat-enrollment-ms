<template>
  <div>
    ...
    <ul class="total-count">
      ...
      <li
        class="tc"
      >单打报名{{singleList.length}}次, 双打报名{{coupeList.length/2}}次，家庭报名{{familyList.length/2}}次</li>
    </ul>
    <el-tabs class="main-tab" v-model="displayMode">
      <el-tab-pane name="all" label="全部">
        <el-table class="user-table" stripe :data="allList">
          <el-table-column width="100px" prop="name" label="姓名"></el-table-column>
          <el-table-column width="75px" prop="age" label="年龄"></el-table-column>
          <el-table-column width="75px" prop="sex" label="性别"></el-table-column>
          <el-table-column width="200px" prop="idCard" label="身份证号"></el-table-column>
          <el-table-column width="150px" prop="phone" label="电话"></el-table-column>
          <el-table-column width="100px" prop="type" label="报名类型"></el-table-column>
          <el-table-column width="75px" prop="groups" label="组别"></el-table-column>
          <el-table-column prop="partNo" label="报名编号"></el-table-column>
